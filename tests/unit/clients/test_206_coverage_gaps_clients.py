...
- FFBBAPIClientV3 search_multiple_* and delegation tests
"""
...
class TestFFBBAPIClientV3Coverage(unittest.TestCase):
    """ffbb_api_client_v3.py -- cover search_multiple_* with None names."""
