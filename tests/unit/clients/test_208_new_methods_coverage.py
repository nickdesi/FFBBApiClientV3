...
class TestNewMethodsCoverage(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get_rencontre_async(self, mock_get_async):
        ...
        # Test delegation
        with patch.object(self.api_client, 'get_rencontre_async', new_callable=AsyncMock) as mock_delegate:
    ...
    async def test_get_engagement_async(self, mock_get_async):
        ...
        # Test delegation
        with patch.object(self.api_client, 'get_engagement_async', new_callable=AsyncMock) as mock_delegate:
            mock_delegate.return_value = res
    ...
    async def test_get_formation_async(self, mock_get_async):
        ...
        # Test delegation
        with patch.object(self.api_client, 'get_formation_async', new_callable=AsyncMock) as mock_delegate:
            mock_delegate.return_value = res
    ...
    async def test_get_entraineur_async(self, mock_get_async):
        ...
        # Test delegation
        with patch.object(self.api_client, 'get_entraineur_async', new_callable=AsyncMock) as mock_delegate:
            mock_delegate.return_value = res
    ...
    async def test_get_commune_async(self, mock_get_async):
        ...
        # Test delegation
        with patch.object(self.api_client, 'get_commune_async', new_callable=AsyncMock) as mock_delegate:
            mock_delegate.return_value = res
    ...
    async def test_get_officiel_async(self, mock_get_async):
        ...
        # Test delegation
        with patch.object(self.api_client, 'get_officiel_async', new_callable=AsyncMock) as mock_delegate:
            mock_delegate.return_value = res
    ...
    async def test_get_salle_async(self, mock_get_async):
        ...
        # Test delegation
        with patch.object(self.api_client, 'get_salle_async', new_callable=AsyncMock) as mock_delegate:
            mock_delegate.return_value = res
    ...
    async def test_get_terrain_async(self, mock_get_async):
        ...
        # Test delegation
        with patch.object(self.api_client, 'get_terrain_async', new_callable=AsyncMock) as mock_delegate:
            mock_delegate.return_value = res
    ...
    async def test_get_tournoi_async(self, mock_get_async):
        ...
        # Test delegation
        with patch.object(self.api_client, 'get_tournoi_async', new_callable=AsyncMock) as mock_delegate:
            mock_delegate.return_value = res
    ...
    async def test_get_pratique_async(self, mock_get_async):
        ...
        # Test delegation
        with patch.object(self.api_client, 'get_pratique_async', new_callable=AsyncMock) as mock_delegate:
            mock_delegate.return_value = res
