...
from ffbb_api_client_v3.models.competition_origine_type_competition_generique import (
    CompetitionOrigineTypeCompetitionGenerique,
)


class Test028CompetitionOrigineTypeCompetitionGenerique(unittest.TestCase):
