# Test Strategy - ffbb-data-client_Python
...
Tests for `FFBBDataClient`, `ApiFFBBAppClient`, `MeilisearchFFBBClient` with mocked HTTP.
...
| `test_204_ffbb_data_client.py` | FFBBDataClient facade | varies |
| `test_205_meilisearch_ffbb_client.py` | MeilisearchFFBBClient (mocked) | 21 |
| `test_206_coverage_gaps_clients.py` | FFBBDataClient search/delegation branches | 5 |
...
| Coverage | `pytest tests/ --cov=ffbb_data_client --cov-branch -q` | Nightly | ~80s |
